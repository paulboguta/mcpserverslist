...
function GitHubStarsButtonSkeleton({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        "flex items-center gap-1.5 text-xs bg-muted/30 text-bg border-muted rounded-md h-6 w-fit border px-1.5 py-0.5 cursor-pointer whitespace-nowrap font-medium shrink-0",
        className,
      )}
    >
      <div className="bg-muted/30 h-[14px] w-[14px] animate-pulse rounded-full" />
      <div className="bg-muted/30 h-3 w-10 animate-pulse rounded" />
      <div className="bg-muted/30 h-[14px] w-[14px] animate-pulse rounded-full" />
      <div className="bg-muted/30 h-3 w-6 animate-pulse rounded" />
    </div>
  );
}
...
function GitHubStarsButton({
  ...
  if (isLoading) {
    return <GitHubStarsButtonSkeleton className={className} />;
  }
  ...
  return (
    <motion.a
      ...
      onClick={handleClick}
      className={cn(
        "flex items-center gap-1.5 text-xs bg-muted/30 text-bg border-muted hover:bg-muted/50 rounded-md h-6 w-fit border px-1.5 py-0.5 has-[>svg]:px-2 cursor-pointer whitespace-nowrap font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-[14px] shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
        className,
      )}
      {...props}
    >
      ...
      <span>GitHub</span>
      <div className="relative inline-flex size-[14px] shrink-0">
        <Star
        ...
        />
        <Star
          className="absolute top-0 left-0 text-white fill-white"
          aria-hidden="true"
          style={{
