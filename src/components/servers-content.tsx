      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {paginatedServers.length > 0 ? (
          ...
          <div className="col-span-2 py-8 text-center">
            <h3 className="text-muted-foreground text-lg font-medium">No servers found</h3>
            <p className="text-muted-foreground mt-1">Check back later for new MCP servers</p>
          </div>
        )}
      </div>
